...
(function($) {
	...
	$.widget("ui.dialogr", {
	  ...
	  _create : function() {
		  ...
		  uiDialogTitlebarClose = $('<a />').addClass('ui-dialog-titlebar-close ' + 'ui-corner-all').attr('role', 'button').hover(function() {
		  ...
		  if (self.options.maximized) {
			  uiDialogTitlebar.append('<a  id="dialog-maximize" class="ui-dialog-titlebar-max"><span>Max</span></a>');
		  ...
		  if (self.options.minimized) {
			  uiDialogTitlebar.append('<a  id="dialog-minimize" class="ui-dialog-titlebar-min"><span>Min</span></a>');
		  ...
		  if (self.options.minimized || self.options.maximized) {
			  ...
			  uiDialogTitlebar.append('<a  id="dialog-restore" class="ui-dialog-titlebar-rest"><span>Restore</span></a>');
