...
function GLTools () {
   ...
   GLTools.prototype.LoadShader = function  ( gl , inUrl , inCallback ) {
   ...
   GLTools.prototype.MakeProgram = function ( inGl , inVertexUrl , inFragmentUrl , inCallback ) {
      var gl               = inGl;
      var attributes       = {};
      var parameters       = {};
      ...
      shaderProgram.vertexShader    = this.LoadShader( gl, inVertexUrl  ,  callback);
      shaderProgram.fragmentShader  = this.LoadShader( gl, inFragmentUrl,  callback);
