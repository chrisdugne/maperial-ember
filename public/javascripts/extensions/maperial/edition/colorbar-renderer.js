...
{
   ExtensionColorbar.bar = new ColorBarRenderer.Bar(50,355,menuDiv,50,40,true,25.4,375.89,false);
...
this.ColorBarRenderer = {};

// -------------------------------------------//

ColorBarRenderer.Rainbow = function(){ 
...
ColorBarRenderer.Bar = function(_width,_height,_mainDiv,_offsetX,_offsetY,_doInterpo,_minVal,_maxVal,_isMovable){
...
//     this.AutoAdd();
  ...
  rainbow = new ColorBarRenderer.Rainbow();
