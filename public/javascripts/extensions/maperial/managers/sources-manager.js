...
SourcesManager.prototype.release = function (source, x, y ,z) {
...
//----------------------------------------------------------------------------------------------------------------------//
   ...
   for(var i = 0; i< this.maperial.context.parameters.sources.length; i++){

      var source = this.maperial.context.parameters.sources[i];
      var requestId = this.requestId(source, x, y, z);
