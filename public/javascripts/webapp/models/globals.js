(function() {
   ...
   var Globals = Ember.Object.extend({
      ...
      APP_URL : (window.location.hostname == "maperial.localhost" || window.location.hostname == "maperial.localhost.deploy") ? 'http://localhost:9000' : 'http://maperial.herokuapp.com',
      WEB_URL : (window.location.hostname == "maperial.localhost" || window.location.hostname == "maperial.localhost.deploy") ? 'http://maperial.localhost/wwwClient/' : 'http://maperial.com/',
      maperialEmail: "",
      currentView: "",
      parentView: "",
      currentPage: "",
